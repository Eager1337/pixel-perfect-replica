...
const faqItems = [
  ...
  { q: "How early should I start planning healthcare before moving?", a: "Ideally 3–6 months before your move. Administrative timing affects continuity, and some steps — like prescription buffers and documentation gathering — take time. The earlier you start, the smoother the transition." },
