    ...
    <section className="section">
      <div className="container">
        <div className="prose-content">
          ...
          <ul><li>Medication naming differences matter — generic names differ from U.S. brand names</li><li>Refill processes differ from the U.S.</li><li>Planning for a prescription buffer before you arrive</li><li>Any specific prescription continuity concerns should be addressed early</li></ul>
