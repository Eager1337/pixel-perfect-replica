    ...
    <section className="section">
      <div className="container">
        <div className="prose-content">
          ...
          <ul><li>Confirming medication names, as generic equivalents matter</li><li>Refill processes differ from the U.S.</li><li>Planning for a prescription buffer before you arrive</li><li>Reviewing your prescription needs and identifying continuity gaps</li></ul>
